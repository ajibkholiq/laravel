                    ...
                    <div class="card-body">
                        <form action="{{ route('blog.update',$data->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="title" placeholder="Masukkan Judul Post" value="{{ $data->title }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="content" rows="5" placeholder="Masukkan Konten Post">{{ $data->content }}</textarea>
